...
public class ShopStateSerializer
{
	...
	{
		var blankWeapon = new Dictionary<WeaponType, ShopItemState> {{WeaponType.Phone, ShopItemState.Selected}};
		...
		if (MainShopController.GetArmsSkinCount() <= 1) return new ShopState(blankWeapon, blankArms, 0, 1, 1);
		{
